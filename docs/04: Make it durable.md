...
```typescript {1} src/index.ts theme={"theme":{"light":"catppuccin-latte","dark":"dark-plus"}}
...
```typescript {3-6} src/index.ts theme={"theme":{"light":"catppuccin-latte","dark":"dark-plus"}}
...
<Accordion title="analytics/src/main.py">
  ```python analytics/src/main.py theme={"theme":{"light":"catppuccin-latte","dark":"dark-plus"}}
  import os
